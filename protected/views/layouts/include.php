...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/_lib/jasny/jasny-bootstrap.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/_lib/bootstrap/css/bootstrap.css" />
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/_lib/jasny/jasny-bootstrap.css" type="text/css" />
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/_lib/jasny/datepicker.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/_lib/bootstrap-others/bootstrap-select.min.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/_public/css/artutor.css" />
